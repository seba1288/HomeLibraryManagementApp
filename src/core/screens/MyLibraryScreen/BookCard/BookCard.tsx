...
function BookCard({ book, onDelete, onBookUpdated }: BookCardProps) {
        ...
        <div className={styles.bookCard}>
            <button className={styles.transparentbutton}>
                <div className={styles.background}>
                    {book.cover_url ? (
                        <img src={book.cover_url} alt={book.title} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.625rem 0.625rem 0 0' }} />
                    ) : (
